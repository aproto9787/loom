...
- Root leaders can configure `oracleAdvisor` policy in Studio's agent Advisors tab: enablement, decision categories, trivial-task skipping, npx fallback, and recording.
