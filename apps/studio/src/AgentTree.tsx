...
import { ChatBubble, countAgentFailures, StreamingBlock, type ChatEntry } from "./ChatTranscript.js";
import {
  getAgentAtPath,
  useRunStore,
  type RunStreamEvent,
...
export function AgentTree({ hideAgentConfig }: { hideAgentConfig?: boolean }) {
  ...
  const failureCount = useMemo(() => countAgentFailures(chatLog), [chatLog]);
