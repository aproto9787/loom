...
- Studio surfaces Oracle connector health in the Plugins view and calls the server's Oracle plugin endpoints for diagnostic manual probes; those UI runs create normal run-history rows with Oracle tool events.
